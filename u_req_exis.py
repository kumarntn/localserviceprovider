...
q="""select * from services where usr_id='%s'"""%(r[1])
cur.execute(q)
r1=cur.fetchall()
cnt=0
print("""
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table">
                                  ...
                                  <tbody>""")
for i in r1:    
	q="""select * from feedbacks where srvc_id='%s' and usr_id='%s'"""%(i[1],r[1])
	cur.execute(q)
	r4=cur.fetchone()
	cnt=cnt+1
	if r4[5]!="":
		...
		if i[10]=='New':
			...
			td="""<a href="usr_payment.py?id=%s&sid=%s" style="color:blue;">Payment</a>"""%(id,i[1]);
		elif i[10]=='Paid':
			td=i[10];
		elif i[10]=='Finished':
			td="""<a href="usr_feedback.py?id=%s&sid=%s" style="color:blue;">Feedback</a>"""%(id,i[1]);
	...
	print("""  <tr>        
						...
						<td>%s</td>
						<td>%s</td>
					</tr>"""%(cnt,i[1],i[2],i[3],i[4],i[8],i[9],td))
