                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="workersreg.py" method="post" enctype="multipart/form-data">
								...
								<div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Experience</label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="expe" class="form-control">
								...
								<div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Type of Service</label></div>
                                        <div class="col-12 col-md-9">
...
print("""		                    <div class="col-12 col-md-9"><input type="text" name="uname" class="form-control" value="%s" readonly></div>
								...
								<div class="form-actions form-group" style="padding:10px;">
									...
									<input type="submit" class="btn btn-success btn-sm" name="sub" value="Submit" style="float:right;margin-right:10px;">
...
if sub!=None:
	...
	pwd=f.getvalue("pwd")
	# print(name,phno,mailid,city,expe,tos,wday,profile,idpf,uname,pwd)
	if profile.filename and idpf.filename:
		...
		q="""insert into workers values('','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')"""%(wkrid,name,phno,mailid,city,expe,tos,wday,fn1,fn2,uname,pwd,'Pending')
		cur.execute(q)
		conn.commit()
		print("""
		<script>
			alert("Registration successfully completed!!");
			location.href="workersreg.py";
		</script>
		""")
