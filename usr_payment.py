...
q1="""select * from services where srvc_id='%s'""" % (sid)
cur.execute(q1)
r1=cur.fetchone()
if sub!=None:
	
		q="""insert into payment values('','%s','%s','%s','%s','%s')"""%(sid,r1[9],r1[5],r1[6],pay)
		cur.execute(q)
		conn.commit()
		q="""update services set status='%s' where srvc_id='%s'"""%('Paid',sid)
		cur.execute(q)
		conn.commit()
		print("""
		<script>
				...
				<div class="animated fadeIn">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="usr_payment.py" method="post" enctype="multipart/form-data">
								...
								<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" class="form-control" value="%s"></div>
                                </div>
								<div class="row form-group">
