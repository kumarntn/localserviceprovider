...
if sub!=None:
	q1="""select * from workers where username='%s' and password='%s'""" % (uname,pwd)
	cur.execute(q1)
	r=cur.fetchone()

	if r!=None:
		if r[13]=='Accept':
			print("""<script>location.href="workersmain.py?id=%s";</script>"""%(r[0]))
		else:
			print("""<script>alert("Your registration is still on processing... ");location.href="workerslog.py";</script>""")
	else:
		print("""<script>alert("Invalid Username or password... ");location.href="workerslog.py";</script>""")
conn.close()
print("""
<!doctype html>
<html>
        ...
        <!-- /#header -->
		  <div class="content" style="margin-top:60px;">
             <div class="animated fadeIn">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">Worker Login</div>
                        <div class="card-body card-block">
                            <form action="workerslog.py" method="post" autocomplete="off">
                               ...
                               <div class="form-actions form-group" style="padding:10px;">
									<a href="workersreg.py" style="color:blue;float:left;">New user click here to register...</a>
