...
if sub!=None:
	q="""update feedbacks set user_feedback='%s' where srvc_id='%s'"""%(fb,sid)
	cur.execute(q)
	conn.commit()
	print("""
		<script>
			alert("Feedback saved successfully!!");
			location.href="u_req_exis.py?id=%s";
		</script>
		"""%(id))
				...
				<div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="usr_feedback.py" method="post" enctype="multipart/form-data">
