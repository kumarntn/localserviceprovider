...
if sub!=None:
	...
	if profile.filename:
		...
		q="""update contractors set profile='%s',password='%s' where id=%s"""%(fn1,pwd,id)
		cur.execute(q)
		conn.commit()
	else:
		q="""update contractors set password='%s' where id=%s"""%(pwd,id)
		cur.execute(q)
		conn.commit()
	print("""
		<script>
			alert("Profile Changed successfully!!");
			location.href="cviewprofile.py?id=%s";
		</script>
		"""%(id))
				...
				<div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="cchangeprofile.py" method="post" enctype="multipart/form-data">
