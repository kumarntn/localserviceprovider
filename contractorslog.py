...
if sub!=None:
	q1="""select * from contractors where username='%s' and password='%s'""" % (uname,pwd)
	cur.execute(q1)
	r=cur.fetchone()

	if r!=None:
		if r[13]=='Accept':
			print("""<script>location.href="contractorsmain.py?id=%s";</script>"""%(r[0]))
		else:
			print("""<script>alert("Your registration is still on processing... ");location.href="contractorslog.py";</script>""")
	else:
		print("""<script>alert("Invalid Username or password... ");location.href="contractorslog.py";</script>""")
conn.close()
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="contractorslog.py" method="post" autocomplete="off">
                               ...
                               <div class="form-actions form-group" style="padding:10px;">
									<a href="contractorsreg.py" style="color:blue;float:left;">New user click here to register...</a>
