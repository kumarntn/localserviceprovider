...
q="""select * from workers where status='Accept'"""
cur.execute(q)
r=cur.fetchall()
cnt=0
print("""
...
for i in r:    
	...
	print("""                          
			<tr>
				...
				<td class="avatar">
					<div class="round-img">
						<a href="%s" target="blank"><img class="rounded-circle" src="%s" alt="" width="50" height="50"></a>
					</div>
				</td>
				<td>%s</td>
				<td>%s</td>
				...
				<td class="avatar">
					<div class="round-img">
						<a href="%s" target="blank"><img class="rounded-circle" src="%s" alt=""width="50" width="50" height="50"></a>
					</div>
				</td>
			
				
			</tr>"""%(cnt,fn,fn,i[1],i[2],i[3],i[4],i[5],i[7],i[8],fn1,fn1))
print("""
       </tbody>
                                </table>
                            </div>
