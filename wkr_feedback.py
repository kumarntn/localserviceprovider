...
if sub!=None:
	q="""update feedbacks set wkr_feedback='%s' where srvc_id='%s'"""%(fb,sid)
	cur.execute(q)
	conn.commit()
	print("""
		<script>
			alert("Feedback saved successfully!!");
			location.href="w_wo_exis.py?id=%s";
		</script>
		"""%(id))
...
q="""select * from services where srvc_id='%s'"""%(sid)
cur.execute(q)
r1=cur.fetchone()
print("""
<!doctype html>
             ...
             <div class="animated fadeIn">
				<div class="row">
						<div class="col-lg-3"></div>
							 <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">Worker Feedback</div>
                        <div class="card-body card-block">
                            <form action="wkr_feedback.py" method="post" enctype="multipart/form-data">
								...
								<div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Feedback</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="fb" class="form-control" required></div>
                                </div>
