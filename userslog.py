...
if sub!=None:
	q1="""select * from users where username='%s' and password='%s'""" % (uname,pwd)
	cur.execute(q1)
	r=cur.fetchone()

	if r!=None:
		print("""<script>location.href="usersmain.py?id=%s";</script>"""%(r[0]))
	else:
		print("""<script>alert("Invalid Username or password... ");location.href="userslog.py";</script>""")
conn.close()
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="userslog.py" method="post" autocomplete="off">
                               ...
                               <div class="form-actions form-group" style="padding:10px;">
									<a href="usersreg.py" style="color:blue;float:left;">New user click here to register...</a>
